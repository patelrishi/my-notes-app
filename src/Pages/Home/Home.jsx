  ...
  return (
    <Fragment>
      ...
      <main className='flex-1 gap-3 overflow-x-hidden'> {/*flex flex-col w-[330px] mt-2 self-center relative */}
        ...
        <div className='m-2 overflow-hidden w-full' >
          <div className=' '>
            <div className=' flex flex-col w-full max-w-[90%] max-w-[240px] sm:max-w-[300px] md:max-w-[500px] lg:max-w-[500px] p-3 mt-2 justify-self-center shadow-2xl rounded-2xl bg-blue-200'>
